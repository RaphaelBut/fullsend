...
'inference provision' and 'mint enroll' before running this command.`,
	...
	cmd.Flags().StringVar(&opts.gitlabRoleMigration, "gitlab-role-migration", "", "GitLab role-credential gate: migrating, enforced, rollback, or disabled (default: provision role credentials and cut over to enforced; rollback and disabled are emergency recovery only)")
